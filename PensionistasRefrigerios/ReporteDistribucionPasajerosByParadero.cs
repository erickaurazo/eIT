...
{
    public partial class ReporteDistribucionPasajerosByParadero : Form
    {
        ...
        private List<SJ_RHDistribucionPersonalPorParaderoResult> listado;
        private MovimientoMovilidadNegocio modelo;
        private string desde;
        private string hasta;
        private string rucProveedor;

        public ReporteDistribucionPasajerosByParadero()
        {
            InitializeComponent();
        ...
        private void ReporteDistribucionPasajerosByParadero_Load(object sender, EventArgs e)
        {
        ...
        {
            string[] cadena = this.txtRazonSocial.Text.ToString().Split('/');
            ...
            if (this.txtNombreComercial.Text != "" && this.txtRazonSocial.Text.ToString().Trim() == "")
            {
        ...
        {
            this.txtRazonSocial.Text = ncadena[0].ToString().Trim();
            this.txtNombreComercial.Text = ncadena[1].ToString().Trim();
        }
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            rucProveedor = this.txtRUC.Text;
            gbDetalleDistribucion.Enabled = false;
        ...
        private void bgwProceso01_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                listado = new List<SJ_RHDistribucionPersonalPorParaderoResult>();
                modelo = new MovimientoMovilidadNegocio();
                listado = modelo.ObtenerListadoDistribucionPasajerosPorParadero(DateTime.Now.Year.ToString(), desde, hasta, rucProveedor).ToList();
            }
            catch (Exception Ex)
            {
        ...
        private void bgwProceso01_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                dgvResultado.DataSource = listado.ToDataTable<SJ_RHDistribucionPersonalPorParaderoResult>();
