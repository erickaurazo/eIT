...
{
    public partial class TipoCaracteristicasHardware : Form
    {
        private PrivilegesByUser privilege;
        private string _companyId;
        private string _conection;
        private SAS_USUARIOS _user2;
        private SAS_DispositivoTipoHardwareController model;
        ...
        public TipoCaracteristicasHardware()
        {
            InitializeComponent();
        ...
        public TipoCaracteristicasHardware(string _conection, SAS_USUARIOS _user2, string _companyId, PrivilegesByUser privilege)
        {
            InitializeComponent();
            RadGridLocalizationProvider.CurrentProvider = new Asistencia.ClaseTelerik.GridLocalizationProviderEspanol();
            RadPageViewLocalizationProvider.CurrentProvider = new Asistencia.ClaseTelerik.RadPageViewLocalizationProviderEspañol();
        ...
        private void CambiarEstado()
        {
            try
            {
                ...
                {
                    model = new SAS_DispositivoTipoHardwareController();
                    int resultado = 0;
        ...
        private void bgwHilo_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                listado = model.GetTypeHardwares("SAS");
            }
            catch (Exception ex)
            {
                RadMessageBox.Show(this, ex.Message, "I/O Error", MessageBoxButtons.OK, RadMessageIcon.Error);
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (oDetalle.descripcion != string.Empty)
                {
                    model = new SAS_DispositivoTipoHardwareController();
                    int resultado = 0;
                    resultado = model.Register("SAS", oDetalle);
                    if (resultado == 1)
                    {
