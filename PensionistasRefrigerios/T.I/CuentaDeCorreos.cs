...
namespace ComparativoHorasVisualSATNISIRA.T.I
{
    ...
    public partial class CuentaDeCorreos : Form
    {
        ...
        private SAS_CuentasCorreoController model;
        ...
        private void CambiarEstado()
        {
            try
            {
                ...
                {
                    model = new SAS_CuentasCorreoController();
                    int resultado = 0;
        ...
        private void AsingarObjeto(SAS_CuentasCorreoListado oDetalle)
        {
            try
            {
                ...
                listDetails = model.GetEmailAccountsDetailById("SAS", account); // Obtener listado detalle
       ...
       // [STAThread]
        private void bgwHilo_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                model = new SAS_CuentasCorreoController();
                listado = model.GetEmailAccounts("SAS");
            ...
            if (((DataGridView)sender).RowCount > 0)
            {
                ...
                if (((DataGridView)sender).CurrentCell.OwningColumn.Name == "chtipo")
                {
                    if (e.KeyCode == Keys.F3)
                    {
                        ...
                        search.ListaGeneralResultado = model.GetType("SAS");
