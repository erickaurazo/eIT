...
{
    public partial class ReportePersonalDesconocidoByPensionByPeriodoFacturacionVistaPrevia : Form
    {
        ...
        private ReportePersonalDesconocidoByPensionByPeriodoFacturacionDS dsReporte;
        private ReportePersonalDesconocidoByPensionByPeriodoFacturacionDSTableAdapters.SJ_RHGenerarReportePersonalDesconocidoByAsistenciaByRefrigeriosByDiaTableAdapter adaptador;



        public ReportePersonalDesconocidoByPensionByPeriodoFacturacionVistaPrevia()
        {
            InitializeComponent();
        }


        public ReportePersonalDesconocidoByPensionByPeriodoFacturacionVistaPrevia(string dniPension, string desde, string hasta)
        {
            InitializeComponent();
            this.desde = desde;
            this.hasta = hasta;
            ...
            try
            {
                dsReporte = new ReportePersonalDesconocidoByPensionByPeriodoFacturacionDS();
                adaptador = new ReportePersonalDesconocidoByPensionByPeriodoFacturacionDSTableAdapters.SJ_RHGenerarReportePersonalDesconocidoByAsistenciaByRefrigeriosByDiaTableAdapter();
                adaptador.Fill(dsReporte.SJ_RHGenerarReportePersonalDesconocidoByAsistenciaByRefrigeriosByDia,  this.desde, this.hasta,this.dniPension);
                dta = new DataTable();
                if (dsReporte.SJ_RHGenerarReportePersonalDesconocidoByAsistenciaByRefrigeriosByDia.Rows.Count <= 0)
                {
                    MessageBox.Show("No se encontró información para imprimir !");
                    return;
                }
                oRpt = new ReportDocument();
                //oRpt.Load(@"X:\Rpt_Solution\AplicacionesNet\rrhh\new\ReportePersonalDesconocidoByPensionByPeriodoFacturacionRPT.rpt");


                oRpt.Load(@"D:\SANJOSE\REPORTES\ReportePersonalDesconocidoByPensionByPeriodoFacturacionRPT.rpt");
                ...
                dta = dsReporte.SJ_RHGenerarReportePersonalDesconocidoByAsistenciaByRefrigeriosByDia;
        ...
        private void ReportePersonalDesconocidoByPensionByPeriodoFacturacionVistaPrevia_Load(object sender, EventArgs e)
        {
            oRpt = new ReportDocument();
        }
