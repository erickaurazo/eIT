...
{
    public partial class ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionVistaPrevia : Form
    {
        ...
        private ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionDS dsReporte;
        private ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionDSTableAdapters.SJ_RHListaPersonalParaDescuentoPensionbyProveedorbyFechaTableAdapter adaptador;


        public ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionVistaPrevia()
        {
            InitializeComponent();
        }

        public ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionVistaPrevia(string dniPension , string desde, string hasta)
        {
            InitializeComponent();
            this.desde = desde;
            this.hasta = hasta;
            ...
            try
            {
                dsReporte = new ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionDS();
                adaptador = new ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionDSTableAdapters.SJ_RHListaPersonalParaDescuentoPensionbyProveedorbyFechaTableAdapter();                
                adaptador.Fill(dsReporte.SJ_RHListaPersonalParaDescuentoPensionbyProveedorbyFecha,this.dniPension, this.desde, this.hasta);
                dta = new DataTable();
                if (dsReporte.SJ_RHListaPersonalParaDescuentoPensionbyProveedorbyFecha.Rows.Count <= 0)
                {
                    MessageBox.Show("No se encontró información para imprimir !");
                    return;
                }
                oRpt = new ReportDocument();
                //oRpt.Load(@"X:\Rpt_Solution\AplicacionesNet\rrhh\new\ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionRPT.rpt");

                oRpt.Load(@"D:\SANJOSE\REPORTES\ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionRPT.rpt");
                ...
                dta = dsReporte.SJ_RHListaPersonalParaDescuentoPensionbyProveedorbyFecha;
        ...
        private void ReportePersonalByDescuentoByInasistenciaByPensionByPeriodoFacturacionVistaPrevia_Load(object sender, EventArgs e)
        {
