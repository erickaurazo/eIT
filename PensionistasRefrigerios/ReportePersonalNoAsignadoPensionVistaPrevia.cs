...
{
    public partial class ReportePersonalNoAsignadoPensionVistaPrevia : Form
    {
        ...
        private ReportePersonalNoAsignadoPension dsReporte;
        private ReportePersonalNoAsignadoPensionTableAdapters.SJ_RHListaPersonalNoAsignadoPensionTableAdapter adaptador;


        public ReportePersonalNoAsignadoPensionVistaPrevia()
        {
            InitializeComponent();
        }

        public ReportePersonalNoAsignadoPensionVistaPrevia(string dniPension, string desde, string hasta)
        {
            InitializeComponent();
            this.desde = desde;
            this.hasta = hasta;
            ...
            try
            {
                dsReporte = new ReportePersonalNoAsignadoPension();
                adaptador = new ReportePersonalNoAsignadoPensionTableAdapters.SJ_RHListaPersonalNoAsignadoPensionTableAdapter();
                adaptador.Fill(dsReporte.SJ_RHListaPersonalNoAsignadoPension, this.dniPension, this.desde, this.hasta );
                dta = new DataTable();
                if (dsReporte.SJ_RHListaPersonalNoAsignadoPension.Rows.Count <= 0)
                {
                    MessageBox.Show("No se encontró información para imprimir !");
                    return;
                }
                oRpt = new ReportDocument();
                //oRpt.Load(@"X:\Rpt_Solution\AplicacionesNet\rrhh\new\ReportePersonalNoAsignadoPensionRPT.rpt");

                oRpt.Load(@"D:\SANJOSE\REPORTES\ReportePersonalNoAsignadoPensionRPT.rpt");
                ...
                dta = dsReporte.SJ_RHListaPersonalNoAsignadoPension;
        ...
        private void ReportePersonalNoAsignadoPensionVistaPrevia_Load(object sender, EventArgs e)
        {
