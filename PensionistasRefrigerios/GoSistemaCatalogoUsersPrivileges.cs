...
namespace Asistencia
{
    public partial class GoSistemaCatalogoUsersPrivileges : Form
    {
        ...
        public GoSistemaCatalogoUsersPrivileges(string userId, string fullName, string conection, ASJ_USUARIOS user, string companyId)
        {
            InitializeComponent();
            _userId = userId;
            _fullName = fullName;
        ...
        private void bgwHilo_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            privileges = model.GetListPrivilegesByUser(_conection, _userId,_companyId);
        }
        ...
        private void btnResetPassword_Click(object sender, EventArgs e)
        {
            if (_fullName != string.Empty && _userId != string.Empty)
            {
                if (dgvList.RowCount > 0)
                {
                    ...
                    if (model.AddListPrivilegesByUser(_conection, privileges,_companyId) == true)
                    {
