...
{
    public partial class ImprimirReporteParaFacturacionSemanaRefrigerios : Form
    {

        public ReportDocument oRpt = new ReportDocument();
        private string codigo;
        private DataTable dta;
        private DSImprimirReporteParaFacturacionSemanaRefrigerios ds;
        private DSImprimirReporteParaFacturacionSemanaRefrigeriosTableAdapters.SJ_RHListarReporteParaFacturacionDetalladoxRefrigeriosxDiaTableAdapter adaptador;



        public ImprimirReporteParaFacturacionSemanaRefrigerios()
        {
            InitializeComponent();
        }

        public ImprimirReporteParaFacturacionSemanaRefrigerios(string codigo)
        {
            InitializeComponent();
            this.codigo = codigo;
            ...
            try
            {
                ds = new DSImprimirReporteParaFacturacionSemanaRefrigerios();
                adaptador = new DSImprimirReporteParaFacturacionSemanaRefrigeriosTableAdapters.SJ_RHListarReporteParaFacturacionDetalladoxRefrigeriosxDiaTableAdapter();
                adaptador.Fill(ds.SJ_RHListarReporteParaFacturacionDetalladoxRefrigeriosxDia, this.codigo);
                dta = new DataTable();
                if (ds.SJ_RHListarReporteParaFacturacionDetalladoxRefrigeriosxDia.Rows.Count <= 0)
                {
                    MessageBox.Show("No se encontró información para imprimir !");
                }
                oRpt = new ReportDocument();

                //oRpt.Load(@"X:\Rpt_Solution\AplicacionesNet\rrhh\ReporteImprimirReporteParaFacturacionSemanaRefrigerios.rpt");


                oRpt.Load(@"D:\SANJOSE\REPORTES\ReporteImprimirReporteParaFacturacionSemanaRefrigerios.rpt");

                //oRpt.Load(@"C:\Users\erick.aurazo\Dropbox\Agricola SJ\Desarrollo\Aplicaciones\Recursos Humanos\RecursosHumanos\PensionistasRefrigerios\ReporteImprimirReporteParaFacturacionSemanaRefrigerios.rpt");
                dta = ds.SJ_RHListarReporteParaFacturacionDetalladoxRefrigeriosxDia;
        ...
        private void ImprimirReporteParaFacturacionSemanaRefrigerios_Load(object sender, EventArgs e)
        {
            oRpt = new ReportDocument();
        }
