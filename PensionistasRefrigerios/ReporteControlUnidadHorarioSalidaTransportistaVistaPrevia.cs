...
{
    public partial class ReporteControlUnidadHorarioSalidaTransportistaVistaPrevia : Form
    {
        ...
        private DSReporteControlUnidadHorarioSalidaTransportista dsReporte;
        private DSReporteControlUnidadHorarioSalidaTransportistaTableAdapters.SJ_ListarAsistenciaSalidaUnidadesTransportePersonalByPeriodoTableAdapter adaptador;

        public ReporteControlUnidadHorarioSalidaTransportistaVistaPrevia()
        {
            InitializeComponent();
        }

        public ReporteControlUnidadHorarioSalidaTransportistaVistaPrevia(string desde, string hasta)
        {
            InitializeComponent();
            this.desde = desde;
            this.hasta = hasta;
            ...
            try
            {
                dsReporte = new DSReporteControlUnidadHorarioSalidaTransportista();
                adaptador = new DSReporteControlUnidadHorarioSalidaTransportistaTableAdapters.SJ_ListarAsistenciaSalidaUnidadesTransportePersonalByPeriodoTableAdapter();                
                adaptador.Fill(dsReporte.SJ_ListarAsistenciaSalidaUnidadesTransportePersonalByPeriodo, this.desde, this.hasta);
                dta = new DataTable();
                if (dsReporte.SJ_ListarAsistenciaSalidaUnidadesTransportePersonalByPeriodo.Rows.Count <= 0)
                {
                    MessageBox.Show("No se encontró información para imprimir !");
                    return;
                }
                oRpt = new ReportDocument();
                //oRpt.Load(@"X:\Rpt_Solution\AplicacionesNet\rrhh\new\ReporteControlUnidadHorarioSalidaTransportistaRPT.rpt");
                //oRpt.Load(@"X:\Rpt_Solution\AplicacionesNet\rrhh\new\FacturacionMovilidadesImprimirDetalleByTipoTransporteRPT.rpt");
                //oRpt.Load(@"C:\Reportes\ReporteControlUnidadHorarioSalidaTransportistaRPT.rpt");

                oRpt.Load(@"D:\SANJOSE\REPORTES\ReporteControlUnidadHorarioSalidaTransportistaRPT.rpt");

                dta = dsReporte.SJ_ListarAsistenciaSalidaUnidadesTransportePersonalByPeriodo;
