...
using ModuloRecursosHumanos;
using ModuloRecursosHumanos.Controller;
using ModuloRecursosHumanos.Modelo;
...
namespace ModuloRecursosHumanos
{
    public partial class Acceso : Form
    {
        ...
        private bool IniciarSesion(string usuario, string clave)
        {
            ...
            {
                userSistema = new SJ_Usuario();
                userSistema = negocio.ObtenerUsuario(usuario, clave);
                UsuarioGlobales.sjUsuario = userSistema;
                resultado = true;
            }
            else
            {
