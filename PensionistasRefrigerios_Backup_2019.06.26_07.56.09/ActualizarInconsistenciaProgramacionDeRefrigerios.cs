...
{
    public partial class ActualizarInconsistenciaProgramacionDeRefrigerios : Form
    {
        ...
        public ActualizarInconsistenciaProgramacionDeRefrigerios()
        {
            InitializeComponent();
            CargarMeses();
        ...
        private void ActualizarInconsistenciaProgramacionDeRefrigerios_Load(object sender, EventArgs e)
        {

        }

        private void btnCorregirInconsitencias_Click(object sender, EventArgs e)
        {
            CorregirInconsitencias();
        }

        private void CorregirInconsitencias()
        {
            try
            {
        ...
        private void bgwProceso_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                modelo.ActualizarInconsistenciaProgramacionRefrigerio(desde, hasta);
            }
            catch (Exception Ex)
            {
