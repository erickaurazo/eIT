...
{
    public partial class AnularAsistenciasDuplicadasAsistenciaPension : Telerik.WinControls.UI.RadForm
    {
        ...
        public AnularAsistenciasDuplicadasAsistenciaPension()
        {
            InitializeComponent();
            CargarMeses();
        ...
        {
            AnularAsistenciasDuplicadas();
        }

        private void AnularAsistenciasDuplicadas()
        {
            try
            {
        ...
        private void AnularAsistenciasDuplicadasAsistenciaPension_Load(object sender, EventArgs e)
        {
