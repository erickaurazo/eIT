...
{
    public partial class ReporteAsistenciaMarcadorBiometrico : Form
    {
        ...
        public ReporteAsistenciaMarcadorBiometrico()
        {
            InitializeComponent();
        }

        public ReporteAsistenciaMarcadorBiometrico(string codigoUnicoAccesoSistema, string codigoUsuario, string codigoTipoPlanilla, string semanaPlanilla)
        {
            InitializeComponent();
        ...
        private void ReporteAsistenciaMarcadorBiometrico_Load(object sender, EventArgs e)
        {
        ...
        {
            dgvRegistros.DataSource = listado.ToDataTable<ext_ListadoAsistenciaMensualizadoResult>();
            dgvRegistros.Enabled = !false;
            gbConsulta.Enabled = !false;
            BarraEstadoF.Visible = !true;
        }
